...
public class PlayerBullet extends GameObject {
    ...
    public static final int MUZZLE_VELOCITY = 600;
    public static final int BULLET_LIFE = 2; // seconds
    public boolean firedByShip;
    Sprite sprite;
    public PlayerBullet(BasicGame g, Vector2D pos, Vector2D vel, boolean firedByShip, Vector2D direction) {
        super(g, pos, vel, RADIUS);
        this.lifetime = BULLET_LIFE;
        this.firedByShip = firedByShip;
        sprite = new Sprite(Sprite.PROJECTILE1, position, direction, radius*2, radius*2);
        sprite.height = 16;
        sprite.width = 16;
    }
